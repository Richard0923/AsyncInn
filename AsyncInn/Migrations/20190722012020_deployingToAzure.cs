...
{
    public partial class deployingToAzure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "Bathroom Not Included" },
                    { 2, 1, "One Bed No Windows" },
                    { 3, 2, "Two Bed and 3 Squatters" },
                    { 4, 0, "Almost a Room" },
                    { 5, 1, "One bedroom rats included" },
                    { 6, 2, "A Suite but without the sweetness" }
                });
